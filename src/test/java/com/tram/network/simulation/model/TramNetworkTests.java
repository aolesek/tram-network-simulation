...
public class TramNetworkTests {
    ...
    public void networkTests() {
        ...
        timetables2.put(new Line(1, LineDirection.NE), s1t2);
        timetables2.put(new Line(1, LineDirection.SW), s1t1);
        ...
        paths.add(
                new Path(4,2,7,s1,s2, s2s1lines)
        );
        ...
        j2s2lines.add(new Line(2, LineDirection.SW));
        paths.add(
                new Path(10,2,7,j2,s3, j2s2lines)
        );
